...
//             card: "bg-white dark:bg-slate-100 shadow-xl",
//             headerTitle: "text-slate-900 dark:text-white",
//             headerSubtitle: "text-slate-600 dark:text-slate-400",
//             socialButtonsBlockButton: 
//               "bg-white dark:bg-slate-500 border border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white hover:bg-slate-50 dark:hover:bg-slate-600",
